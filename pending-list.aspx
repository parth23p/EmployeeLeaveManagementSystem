<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="pending-list.aspx.cs" Inherits="LeaveMangaement.pending_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid bg-light mt-5" >
         <asp:Panel runat="server" ID="p1">
            <asp:Label ID="i1" runat="server" Font-Size="xx-Large" CssClass="ml-5 text-danger" Text="You haven't any leaves pending for 'Approval or Denial'."
                Font-Bold="true"></asp:Label><br />
        </asp:Panel>
        <asp:Panel runat="server" ID="Panel1"  HorizontalAlign="center" Font-Size="Medium">
    <table class="table  table-scripted bg-white shadow-lg" style=" margin-left: auto;margin-right: auto;z-index:3;box-shadow:3px 3px 3px #c8c8c8;border:0px solid whitesmoke;border-radius:8px">
