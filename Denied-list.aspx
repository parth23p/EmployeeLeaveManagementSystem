<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Denied-list.aspx.cs" Inherits="LeaveMangaement.denied_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid bg-light mt-5" >
          <asp:Panel runat="server" ID="p1">
            <asp:Label ID="i1" runat="server" Font-Size="xx-Large" Class=" ml-5 text-center text-danger"  Text="You haven't Denied any Leaves yet!"
